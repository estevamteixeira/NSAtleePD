...
tbl[,1] <- c("# women with labour or induction", "Vaginal delivery", "Caesarean section")
...
tbl[,1] <- c("# VBAC candidates", "Dilation to 4 cm or induction attempt", "Less than 4 cm and no induction attempt")
...
# Specifying colors by age group
  ...
  scale_y_continuous(#trans = 'log2',
    ...
    labels = scales::percent_format(accuracy = 1),
    limits = c(0, NA)) +
  labs(y = '% with 4 cm labour or induction', x = '') +
  theme_minimal()
...
tbl[,1] <- c("# with 4 cm labour or induction", "Vaginal delivery", "Caesarean section")
...
# Specifying colors by age group
  ...
  scale_y_continuous(#trans = 'log2',
    ...
    labels = scales::percent_format(accuracy = 1),
    limits = c(0, NA)) +
  labs(y = '% of vaginal deliveries', x = '') +
  theme_minimal()
...
tbl1[,1] <- c("# vaginal deliveries", "% episiotomy")
...
tbl2[,1] <- c("# vaginal deliveries", "% episiotomy")
...
tbl[,1] <- c("# deliveries", "% Obstetrical intervention")
