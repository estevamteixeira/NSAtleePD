...
# kableExtra::kable_styling(font_size = 12) %>%
# kableExtra::add_footnote(label = c("With known parity",
#                                    "Note: Partnered denotes women who are 'married', who are in a 'common-law' relationship, or who have a 'partner, not othwerwise specified'. The 'partner' option started to be collected on April 1\u02e2\u1d57, 2020."))
