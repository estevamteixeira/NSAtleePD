...
params:
  year1: 2011
  year2: 2020
subtitle: "Report of Indicators: `r paste0(params$year1,'-',params$year2)`"
...
<img src="images/Cover2011-2020.png" width="250" height="325" alt="The NS Atlee Perinatal Database cover" align="right" style="margin: 0 1em 0 1em; border:2px solid #008d8b" />
<!-- </a> -->
...
```{r becky, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='40%'}
knitr::include_graphics("images/Becky20.jpg")
```
...
```{r logos, results = 'asis', eval=knitr::is_latex_output(), echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='95%'}
cat("\\begin{figure*}[b]\n")
cat("\\centering\n")
cat("\\includegraphics[width=0.95\\textwidth]{images/3_logos_3.png}\n")
cat("\\end{figure*}\n")
