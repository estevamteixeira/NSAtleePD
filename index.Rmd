...
- [Citing](https://github.com/Robinlovelace/geocompr/raw/main/CITATION.bib) or [linking-to](http://rcp.nshealth.ca/sites/default/files/publications/APD_Report_2010_2019.pdf) it
...
```{r dora, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', out.width='20%'}
...
```{r alec, echo=FALSE, fig.align='center', out.width='20%'}
