...
reactable(tbl,
  ...
  reactablefmtr::add_source("Phototherapy involves exposure of the neonate to coloured light in hospital (birth hospital or readmission in the neonatal period). It is given for known or suspected hyperbilirubinemia (jaundice).",
                            font_size = 12,
                            #font_weight = "bold"
  )
...
reactable(tbl,
  ...
  reactablefmtr::add_source("TTN = Transient tachypnea of the newborn.",
                            font_size = 12,
                            #font_weight = "bold"
  ) %>%
