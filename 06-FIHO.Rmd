...
pal <- c("< 3\u02b3\u1d48 percentile" = "#1b9e77",
         ...
         "< 10\u1d57\u02b0 percentile" = "#e7298a")

plot <- ggplot(data = dta1[!lbw %in% c("[3\u02b3\u1d48, 10\u1d57\u02b0) percentile",
                                       "\u2265 10\u1d57\u02b0 percentile")],
               aes(x = BrthYear,
                   y = rate,
                   group = lbw,
...
pal <- c("\u2264 90\u1d57\u02b0 percentile" = "#1b9e77",
         ...
         "\u2265 90\u1d57\u02b0 percentile" = "#e7298a")

plot <- ggplot(data = dta1[!lbw %in% c("[90\u1d57\u02b0, 95\u1d57\u02b0) percentile", 
                                       "\u2264 90\u1d57\u02b0 percentile")],
               aes(x = BrthYear,
                   y = rate,
                   group = lbw,
...
tbl[,1] <- c("# live births", "\u2265 97\u1d57\u02b0 percentile", "\u2265 90\u1d57\u02b0 percentile")
