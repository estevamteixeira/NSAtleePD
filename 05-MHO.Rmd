...
plot <- ggplot(data = dta1[!tolower(lacer) %in% "no"],
  ...
  scale_y_continuous(#trans = 'log2',
    ...
    labels = scales::percent_format(accuracy = .1),
    limits = c(0, NA)) +
  labs(y = 'Proportion of primiparous vaginal deliveries', x = '') +
  theme_classic()
...
tbl[,1] <- c("Total primiparous vaginal deliveries", "2\u207f\u1d48 degree laceration", "3\u02b3\u1d48 or 4\u1d57\u02b0 degree laceration")
...
plot <- ggplot(data = dta1[!tolower(lacer) %in% "no"],
  ...
  scale_y_continuous(#trans = 'log2',
    ...
    labels = scales::percent_format(accuracy = .1),
    limits = c(0, NA)) +
  labs(y = 'Proportion of multiparous vaginal deliveries', x = '') +
  theme_classic()
...
tbl[,1] <- c("Total multiparous vaginal deliveries", "2\u207f\u1d48 degree laceration", "3\u02b3\u1d48 or 4\u1d57\u02b0 degree laceration")
