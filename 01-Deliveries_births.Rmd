...
## Number of deliveries (live births and stillbirths) to residents by year, Nova Scotia, `r paste0(params$year1,"-",params$year2)`
...
## Number of births by year, Nova Scotia, `r paste0(params$year1,"-",params$year2)`
...
## Number of births by outcome, sex, and year, Nova Scotia, `r paste0(params$year1,"-",params$year2)`
...
## Deliveries resulting from assisted reproductive technology, Nova Scotia, `r paste0(params$year1,"-",params$year2)`
